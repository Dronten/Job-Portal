    ...
    const applyJobHandler = async () => {
        try {
            ...
            if (res.data.success) {
                ...
                dispatch(setSingleJob(updatedSingleJobs)); // updates the UI in real time
        ...
        const fetchSingleJob = async () => {
            try {
                ...
                if (res.data.success) {
                    ...
                    setIsApplied(res.data.job.applications.some(application => application.applicant == user?._id)) // Check if the user has already applied
                }
            } catch (error) {
                console.log(error);
            }
